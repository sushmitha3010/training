...
<h1>Welcome To Speed Post !!!</h1>

<form id="speedForm" name="form" action="/speedPost" onsubmit="speedForms()" method="post" align="center">
     ...
     &nbsp; &nbsp; &nbsp;  <label>SenderName:</label>
                    ...
                    <br>
                    &nbsp; &nbsp; &nbsp;<input type="number" name="Kms" id="Kms" placeholder="Kms">
                    <br><br>
